    ...
    <div className="fixed right-16 top-0 h-full hidden md:flex flex-col justify-center items-end pr-4 ">
      <div className="flex flex-col gap-4 border border-gray-300 py-3 px-1 rounded-full">
        ...
        <div className="relative group">
          ...
          <i className="fa-regular fa-envelope text-gray-300 text-xl hover:text-teal-400 p-2"></i>
        </div>
        ...
        <div className="relative group">
          ...
          <i className="fa-brands fa-linkedin-in text-gray-300 text-xl hover:text-teal-400 p-2"></i>
        </div>
        ...
        <div className="relative group">
          ...
          <i className="fa-brands fa-github text-gray-300 text-xl hover:text-teal-400 p-2"></i>
        </div>
